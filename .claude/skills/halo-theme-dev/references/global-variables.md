...
**Example** (based on the settings.yaml in structure-and-config.md):
...
based on semantic version ranges.
...
Boolean. Evaluates both "is a comment plugin installed" and "are comments enabled for this page".
